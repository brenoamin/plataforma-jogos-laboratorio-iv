...
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/18.1/cpu {C:/intelFPGA_lite/18.1/cpu/cpu.v}
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/18.1/processor {C:/intelFPGA_lite/18.1/processor/mem_program.v}
vcom -93 -work work {C:/intelFPGA_lite/18.1/processor/mem_data.vhd}

vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/18.1/processor {C:/intelFPGA_lite/18.1/processor/processor_test.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  processor_test
